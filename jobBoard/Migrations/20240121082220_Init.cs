        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplyUrl = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c4c82eb-d3ab-44de-ae5f-c0184ad48782"), null, "Admin", "ADMIN" },
                    { new Guid("4bc94486-a21a-4ae7-8438-606dbacbd65a"), null, "JobSeeker", "JOBSEEKER" },
                    { new Guid("5642f725-d620-4e85-858e-a4db9defccb1"), null, "Business", "BUSINESS" }
                });
